@extends('layouts.app') {{-- Asume que tienes un layout principal llamado app.blade.php --}}
 ...
 <div class="container-fluid">
     <div class="row">
         <div class="col-md-12">
             <h1 class="mb-4">Reporte de Graduados por Carrera</h1>
         </div>
     </div>
             ...
             <form action="#" method="GET">
                 <div class="row g-3">
                     ...
                     <div class="col-md-3">
                         ...
                         <select class="form-select" id="anio_graduacion" name="anio_graduacion">
                     ...
                     <div class="col-md-3">
                         ...
                         <select class="form-select" id="ciclo_graduacion" name="ciclo_graduacion">
